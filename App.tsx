...
const App: React.FC = () => {
  ...
  const handleDeleteCurrentImage = useCallback(async () => {
    ...
    try {
      ...
      const newImageUrls = imageUrls.filter((_, idx) => idx !== removedIndex);
      const newImagePaths = imagePaths.filter((_, idx) => idx !== removedIndex);
  ...
  }, [imageFiles, currentIndex, imageUrls, imagePaths, allAnnotations, allAnnotationTimes, allActiveAnnotationTimes, allImageDimensions, completedImages, outputPaths, currentDirectory, resetInactivityTimer]);
