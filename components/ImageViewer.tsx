...
const ImageViewer: React.ForwardRefRenderFunction<ImageViewerApi, ImageViewerProps> = (
  { 
    ...
    selectedAnnotationClass, selectedAnnotationId, onAddAnnotation, onSelectAnnotation, imageDimensions
  },
  ref
) => {
  ...
  }, [getTransformedPoint, selectedAnnotationClass, imageDimensions]);
  ...
  const handleDrawEnd = useCallback(() => {
    ...
    setCurrentPath([]);
  }, [isDrawing, currentPath, selectedAnnotationClass, onAddAnnotation]);
