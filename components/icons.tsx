...
export const ResetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    ...
    >
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.475 12C2.475 12 5.25 5.25 12 5.25s9.525 6.75 9.525 6.75-2.775 6.75-9.525 6.75S2.475 12 2.475 12Z" />
    </svg>
);
...
export const HardDriveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
...
export const ChartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3 3v18h18M7.5 15.75V18M12 12.75V18m4.5-7.5V18"
    />
  </svg>
);
